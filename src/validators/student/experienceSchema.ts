...
export const experienceSchema = z
    .object({
        ...
        offer_letter_url: z.string().url("Must be a valid URL").optional().or(z.literal("")),
        completion_certificate_url: z.string().url("Must be a valid URL").optional().or(z.literal("")),
    })
    .refine(
        (data) => {
