...
export const NOTIFICATION_TYPE_LABELS: Record<NotificationType, string> = {
    ...
    round_processing_complete: "Round Processing Complete",
};
...
> = {
    ...
    profile_approved: BadgeCheck,
    profile_rejected: FileX2,
    item_verified: BadgeCheck,
    item_rejected: FileX2,
