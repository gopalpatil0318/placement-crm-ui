...
import { Menu, Search, Sun, Sliders, Settings, Zap, Bell } from "lucide-react";

/**
 * Header component for the College Admin module.
 * Mirrors the sysadmin header structure for design consistency.
 */
  ...
  return (
    <header className="sticky top-0 z-10 w-full h-16 bg-white border-b flex items-center justify-between px-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="ml-2">
          <img
            src="https://i.pravatar.cc/40?u=collegeadmin"
            alt="College Admin"
...
/**
 * Reusable icon button component for header actions.
 */
