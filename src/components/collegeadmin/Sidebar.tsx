...
export default function Sidebar({ isOpen, onClose, isMobile = false }: Readonly<SidebarProps>) {
  ...
  return (
    <>
      ...
      >
        {/* College branding */}
        <div className="px-4 py-4 flex items-center gap-2.5 shrink-0 min-h-[56px]">
          {college && sanitizeImageUrl(college.college_logo_url) && !logoError ? (
            ...
            <div className="h-8 w-8 shrink-0 rounded-lg bg-blue-100 dark:bg-blue-900/40 flex items-center justify-center">
