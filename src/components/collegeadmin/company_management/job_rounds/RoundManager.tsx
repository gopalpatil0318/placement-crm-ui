...
const RoundCard = ({
    ...
    const status = round.round_status;
    let numberBadgeClass: string;
    if (status === "completed") {
        numberBadgeClass = "bg-emerald-50 dark:bg-emerald-900/20 border-emerald-300 dark:border-emerald-700 text-emerald-700 dark:text-emerald-400";
    } else if (status === "in_progress") {
        numberBadgeClass = "bg-blue-50 dark:bg-blue-900/20 border-blue-300 dark:border-blue-700 text-blue-700 dark:text-blue-400";
    } else if (status === "cancelled") {
        numberBadgeClass = "bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800 text-red-400 dark:text-red-500";
    } else {
        numberBadgeClass = "bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400";
    }

    let connectorClass: string;
    if (status === "completed") {
        connectorClass = "bg-emerald-200 dark:bg-emerald-700";
    } else if (status === "in_progress") {
        connectorClass = "bg-blue-200 dark:bg-blue-700";
    } else {
        connectorClass = "bg-gray-200 dark:bg-gray-700";
    }

    let cardClass: string;
    if (status === "cancelled") {
        cardClass = "bg-gray-50/50 dark:bg-gray-800/50 border-gray-100 dark:border-gray-800 opacity-60";
    } else if (status === "completed") {
        cardClass = "bg-white dark:bg-gray-900 border-emerald-200 dark:border-emerald-800 shadow-sm";
    } else if (status === "in_progress") {
        cardClass = "bg-white dark:bg-gray-900 border-blue-200 dark:border-blue-800 shadow-sm";
    } else {
        cardClass = "bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 hover:shadow-sm";
    }
    ...
    return (
        <div className="flex gap-4">
            ...
            <div className="flex flex-col items-center flex-shrink-0">
                <div
                    className={`h-9 w-9 rounded-full flex items-center justify-center text-xs font-bold border-2 ${numberBadgeClass}`}
                >
                    {round.round_number}
                </div>
                {!isLast && (
                    <div
                        className={`w-0.5 flex-1 min-h-[24px] mt-1 rounded-full ${connectorClass}`}
                    />
                )}
            </div>
            ...
            {/* Right: card content */}
            <div
                className={`flex-1 p-4 rounded-xl border transition-all mb-3 ${cardClass}`}
            >
                {/* Card header */}
                ...
                <div className="flex items-center gap-1 mt-3 pt-3 border-t border-gray-100 dark:border-gray-800">
                    <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-2.5 min-h-[44px] text-xs font-medium text-gray-500 dark:text-gray-400 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:text-blue-600 dark:hover:text-blue-400 transition"
                            ...
                            transitions.map((status) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`inline-flex items-center gap-1.5 px-3 py-2.5 min-h-[44px] text-xs font-medium text-gray-500 dark:text-gray-400 rounded-lg transition ${action.hoverBg} ${action.hoverText}`}
                                        title={action.label}
                                    >
        ...
        >
            <div className="p-6 space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label htmlFor="add-round-date" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
    ...
    return (
        ...
        >
            <div className="p-6 space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label htmlFor="edit-round-date" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                            Date & Time
                        </label>
                        <input
                            id="edit-round-date"
