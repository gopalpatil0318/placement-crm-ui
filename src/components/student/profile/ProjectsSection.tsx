                            ...
                            >
                                ...
                                >
                                    <div className="min-w-0 flex-1">
                                        ...
                                        {/* Show description preview only when collapsed */}
                                        ...
                                        <div className="flex flex-wrap gap-2 pt-1">
                                            {project.github_link && (
                                                <a
                                                    ...
                                                    className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-xs font-medium bg-gray-900 text-white hover:bg-gray-800 transition-colors"
                                                >
