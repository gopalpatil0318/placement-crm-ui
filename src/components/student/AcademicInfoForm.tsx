...
import { ADMISSION_OPTIONS } from "@/constants/academicInfo";
        ...
        <div className="p-8 bg-white dark:bg-gray-900 rounded-xl border dark:border-gray-800">
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <FloatingInput label="Admission Year" name="admission_year" value={String(formData.admission_year ?? "")} onChange={handleChange} error={errors.admission_year} required type="number" inputMode="numeric" />
                    <FloatingSelect label="Admission Based On" name="admission_based_on" value={String(formData.admission_based_on ?? "")} onChange={handleChange} error={errors.admission_based_on} required options={ADMISSION_OPTIONS} />
                </div>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <FloatingInput label="Percentage (%)" name="tenth_percentage" value={String(formData.tenth_percentage ?? "")} onChange={handleChange} error={errors.tenth_percentage} required type="number" inputMode="decimal" />
                        ...
                        <FloatingInput label="Passing Year" name="tenth_passing_year" value={String(formData.tenth_passing_year ?? "")} onChange={handleChange} error={errors.tenth_passing_year} required type="number" inputMode="numeric" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    {formData.twelfth_or_diploma === "12th" && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <FloatingInput label="12th Percentage (%)" name="twelfth_percentage" value={String(formData.twelfth_percentage ?? "")} onChange={handleChange} error={errors.twelfth_percentage} required type="number" inputMode="decimal" />
                    ...
                    {formData.twelfth_or_diploma === "Diploma" && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <FloatingInput label="Diploma Percentage (%)" name="diploma_percentage" value={String(formData.diploma_percentage ?? "")} onChange={handleChange} error={errors.diploma_percentage} required type="number" inputMode="decimal" />
                    ...
                    <div className="mt-6">
                        <FloatingInput label="Passing Year" name="higher_education_passing_year" value={String(formData.higher_education_passing_year ?? "")} onChange={handleChange} error={errors.higher_education_passing_year} required type="number" inputMode="numeric" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <FloatingInput label="Overall CGPA (/10)" name="overall_cgpa" value={String(formData.overall_cgpa ?? "")} onChange={handleChange} error={errors.overall_cgpa} required type="number" inputMode="decimal" />
                        <FloatingInput label="Total Live KTs" name="total_live_kts" value={String(formData.total_live_kts ?? "")} onChange={handleChange} error={errors.total_live_kts} required type="number" inputMode="numeric" />
                        <FloatingInput label="Total Dead KTs" name="total_dead_kts" value={String(formData.total_dead_kts ?? "")} onChange={handleChange} error={errors.total_dead_kts} required type="number" inputMode="numeric" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    {formData.any_gap_during_education && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <FloatingInput label="Gap Years" name="gap_years" value={String(formData.gap_years ?? "")} onChange={handleChange} error={errors.gap_years} required type="number" inputMode="numeric" />
