...
import { ChevronLeft, ChevronRight, Search, ClipboardCheck, Eye } from "lucide-react";
...
const BREADCRUMBS = [
    ...
    { label: "Eligibility Criteria", active: true },
];
    ...
    return (
        <DashboardLayout>
            <div className="space-y-8">
                <PageHeader title="Job Eligibility Criteria" breadcrumbs={BREADCRUMBS} />
                    ...
                    <div className="p-8 bg-white rounded-xl border">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                            <div className="flex items-center gap-3">
                                <h1 className="text-xl font-semibold text-gray-800">Manage Eligibility Criteria</h1>
                                {!loading && (
                                                ...
                                                >
                                                    ...
                                                    <td className="px-4 py-3">
                                                        <div className="flex items-center gap-2">
                                                            <button
                                                                type="button"
                                                                onClick={() => navigate(`/college/job/${job.job_id}/criteria`)}
                                                            ...
                                                            >
                                                                <ClipboardCheck size={12} /> Criteria
                                                            </button>
                                                            <button
                                                                type="button"
                                                                onClick={() => navigate(`/college/job/${job.job_id}/eligible-students`)}
...
export default ViewJobCriteria;
