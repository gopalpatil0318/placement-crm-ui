...
export const useVerifyJoiningLetter = (onSuccess: () => void) => {
    ...
    const mutation = useMutation({
        ...
        }) => CollegeAdminService.verifyJoiningLetter(placementId, payload),
    ...
    const verifyJoining = useCallback(
        (
            placementId: string,
    ...
    return { loading: mutation.isPending, verifyJoining };
};
